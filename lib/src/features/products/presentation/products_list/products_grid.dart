...
class ProductsGrid extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    // final products = ref.watch(fakeProductsRepositoryProvider).getProductsList();
  ...
  ProductsLayoutGrid _buildProductsGrid(BuildContext context, List<Product> products) {
