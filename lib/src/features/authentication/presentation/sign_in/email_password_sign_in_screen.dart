  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: EmailPasswordSignInContents(
        formType: formType,
        //* we added refreshListenable: in goRouterProvider to refresh the router when the user signs in, so we no longer need to call pop here
...
class _EmailPasswordSignInContentsState
  ...
  @override
  Widget build(BuildContext context) {
    // listen to both formType and value of the EmailPasswordSignInState
    // ref.listen<EmailPasswordSignInState>(emailPasswordSignInControllerProvider(widget.formType), (previousState, state) 
    //   => state.value.showAlertDialogOnError(context)
    // );

    // listen to the value of the EmailPasswordSignInState
    ref.listen<AsyncValue>(
      emailPasswordSignInControllerProvider(widget.formType).select( (state) => state.value), (previousAsyncValue, currentAsyncValue) 
      => currentAsyncValue.showAlertDialogOnError(context)
    );
